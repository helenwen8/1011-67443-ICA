...
var totalHumans = humanOfficers.count


// Q1: What percentage of humans are female?
var females = humanOfficers.filter{ femaleOfficers.contains($0)}.count
var percent = Float(females) / Float(totalHumans)

// Q2: How many first officers are human?
var first = humanOfficers.filter{ firstOfficers.keys.contains($0)}.count
var totalFirst = firstOfficers.count
var percent2 = Float(first) / Float(totalFirst)
...
let cnt = vulcanFirstOfficers.filter{$0.name.count < 5}
print (cnt.count)
